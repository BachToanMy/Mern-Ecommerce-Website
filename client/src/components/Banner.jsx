          ...
          <div key={index} className=" relative">
            ...
            <div className=" absolute top-0 left-0 w-full h-full bg-black/20 ">
              <Container className="flex flex-col justify-center gap-2 md:gap-3 h-full">
                ...
                <button onClick={()=>navigate("/shop")} className="w-24 md:w-44 py-2 md:py-0 md:h-12 bg-black/80 text-white rounded-md text-xs md:text-sm uppercase hover:bg-black hoverEffect font-semibold">
                  Shop Now
                </button>
              </Container>
            </div>
